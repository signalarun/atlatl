 ...
 * @param {*} next 
 */
exports.listSessions = function(req, res, next){
    
    let users = account.listSession(function(sessions){
        res.status(StatusCodes.OK).json(new ApiResponse(sessions, StatusCodes.OK).build());
    }, {}, {offset : req.query.offset, limit : req.query.limit, select : 'session expires'});
};
